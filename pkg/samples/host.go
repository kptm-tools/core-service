...
func SampleHosts() []domain.Host {
	...
	return []domain.Host{
		...
		*domain.NewHost("https://www.example.com", "", c.FusionAuth.BlueprintTenantID, "00000000-0000-0000-0000-222222222222", "example-website", []domain.Credential{}, []domain.Rapporteur{}),
	}
}
