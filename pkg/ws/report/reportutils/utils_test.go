	...
	}{
		{
			...
			want: dto.InitialDataResponse{
				VulnerabilityTypes: []dto.VulnerabilityTypeData{
					{Name: enums.OwaspCategorySSRF.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategorySoftwareAndDataIntegrityFailures.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryCryptographicFailures.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryIdentificationAndAuthenticationFailures.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryBrokenAccessControl.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategorySecurityLoggingAndMonitoringFailures.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryInjection.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryVulnerableAndOutdatedComponents.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryInsecureDesign.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategorySecurityMisconfiguration.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryOther.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
					{Name: enums.OwaspCategoryNoInfo.String(), HighestCvss: 0, Count: 0, Percentage: 0, AvailableCvssValues: []float64{0}},
				},
