...
Of course. Based on the new IScanService interface definition, here is the completely refactored mock implementation.

This new MockScanService accurately reflects the methods, signatures, and types of the new interface, and follows the strict "panic if not implemented" pattern for robust testing. Obsolete methods from the old file have been removed.
File: mock_scan_service.go
Go
...
import (
	...
	"github.com/kptm-tools/core-service/pkg/enums"
	"github.com/kptm-tools/core-service/pkg/interfaces"
)

// MockScanService provides a "strict" mock implementation of the interfaces.IScanService.
// If a method is called without a corresponding mock function being set in the test,
// it will panic, forcing the developer to provide an explicit implementation.
...
func (m *MockScanService) CreateScan(ctx context.Context, hostID uuid.UUID, tenantID, operatorID uuid.UUID, startedAt *time.Time) (*domain.Scan, error) {
	...
	panic(fmt.Sprintf("MockScanService: method CreateScan called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetCurrentScans(ctx context.Context, tenantID uuid.UUID) ([]domain.ScanSummary, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetCurrentScans called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) InsertScanResult(ctx context.Context, result domain.ScanResult) error {
	...
	panic(fmt.Sprintf("MockScanService: method InsertScanResult called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) UpdateScanStatus(ctx context.Context, scanID uuid.UUID, status enums.ScanStatus) error {
	...
	panic(fmt.Sprintf("MockScanService: method UpdateScanStatus called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) MarkScanAsFailed(ctx context.Context, scanID uuid.UUID) error {
	...
	panic(fmt.Sprintf("MockScanService: method MarkScanAsFailed called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) MarkScanAsCancelled(ctx context.Context, scanID uuid.UUID) error {
	...
	panic(fmt.Sprintf("MockScanService: method MarkScanAsCancelled called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetScanInsights(ctx context.Context, scanID uuid.UUID) (*domain.ScanInsights, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetScanInsights called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) CalculateProtectionScore(ctx context.Context, scanID uuid.UUID) (float64, error) {
	...
	panic(fmt.Sprintf("MockScanService: method CalculateProtectionScore called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetScanByID(ctx context.Context, scanID uuid.UUID) (*domain.Scan, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetScanByID called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) HandleScanCompletion(ctx context.Context, scanID uuid.UUID) error {
	...
	panic(fmt.Sprintf("MockScanService: method HandleScanCompletion called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetScanVulnerabilitySummaryByID(ctx context.Context, scanID uuid.UUID, timePeriodFilter domain.TimePeriodFilter, severityFilters []string) (*domain.ScanVulnerabilitySummaryData, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetScanVulnerabilitySummaryByID called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetAllReportsForTenant(ctx context.Context, tenantID uuid.UUID) ([]domain.ReportItem, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetAllReportsForTenant called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetScoreCardTrendsForTenant(ctx context.Context, tenantID uuid.UUID, fromDate, toDate *time.Time) ([]*domain.ScoreCardTrendItem, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetScoreCardTrendsForTenant called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetScanVulnerabilities(ctx context.Context, scanID uuid.UUID) ([]tools.Vulnerability, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetScanVulnerabilities called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetSeverityCounts(ctx context.Context, scanID uuid.UUID) (tools.SeverityCounts, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetSeverityCounts called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) CreateTarget(ctx context.Context, hostID uuid.UUID) (*results.Target, error) {
	...
	panic(fmt.Sprintf("MockScanService: method CreateTarget called but not implemented for test: %s", ctx.Value("test_name")))
}
...
func (m *MockScanService) GetScanRapporteursAndHostAlias(ctx context.Context, scanID uuid.UUID) ([]domain.Rapporteur, string, error) {
	...
	panic(fmt.Sprintf("MockScanService: method GetScanRapporteursAndHostAlias called but not implemented for test: %s", ctx.Value("test_name")))
}
