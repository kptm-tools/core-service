...
type MockScanService struct {
	...
	MockGetRapporteursScan func(id uuid.UUID) ([]*domain.Rapporteur, string, error)
}
...
func (m *MockScanService) GetRapporteursScan(id uuid.UUID) ([]*domain.Rapporteur, string, error) {
