...
func (h *WebScanHandler) startWorkers() {
...
func (h *WebScanHandler) HandleMessage(msg *nats.Msg) {
	...
	case <-timer.C:
		...
		h.dropped.Add(1)
		slog.Warn("WebScanEvent queue full, dropping message")
	}
}
...
func (h *WebScanHandler) GetMetrics() map[string]interface{} {
