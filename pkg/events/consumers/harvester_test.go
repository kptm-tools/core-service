...
func TestProcessHarvesterEvent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := NewHarvesterHandler(tt.scanService, 1)
...
func TestWorkerPoolSize_Harvester(t *testing.T) {
	...
	handler := NewHarvesterHandler(scanService, workerCount)
	eventCount := 20
...
func TestConcurrentEventHandling_Harvester(t *testing.T) {
...
func TestWorkerFailures_Harvester(t *testing.T) {
...
func BenchmarkEventProcessing_Harvester(b *testing.B) {
	...
	for _, workers := range workerCounts {
		b.Run(fmt.Sprintf("Workers-%d", workers), func(b *testing.B) {
			...
			handler := NewHarvesterHandler(scanService, workers)
...
func TestBackpressureHandling_Harvester(t *testing.T) {
